...
import ArtisticGroupsColumnWithActions from './ArtisticGroupsColumnWithActions';
// import { Fragment } from 'react';
// import CyclicalActivityColumnWithActions from './CyclicalActivityColumnWithActions';

export const columnsArtisticGroups: ColumnDef<ArtisticGroup>[] = [
  {
    id: 'select',
    header: ({ table }) => {
      return (
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const artisticGroup = row.original;
      return <ArtisticGroupsColumnWithActions artisticGroup={artisticGroup} />;
    },
  },
];
