...
export default function RichTextEditorFormik<T>(props: Props<T>) {
  ...
  //unfortunately I resigned since Quill and import { Quill } from 'react-quill' causes Next js to hang when building project - it needs window.document that's unavailable in SSR, and I could find solution to add custom icons for h3,h4...
