        ...
        <div className="proper-container-classes bg-skin-main-bg drop-shadow-none slider-break-point:drop-shadow-big rounded-base">
          <div className="flex flex-col items-start justify-start gap-6 slider-break-point:flex-row">
            ...
            <div className="flex-1 pb-8 prose">
              ...
              <p>
                <b>Art CK </b>
                to miejsce, które zostało stworzone z myślą nie tylko o
                pasjonatach szeroko pojętej kultury i sztuki, ale o wszystkich,
                którzy marzą o swobodnym spędzaniu czasu w przyjaznej, pełnej
                ciepła atmosferze.
              </p>
              <p>
                Pragniemy, by nasze miasto stało się centrum artystycznych
                przeżyć i niezapomnianych doświadczeń. ART CK to przestrzeń, w
                której kultura ma wymiar niecodzienny - odbiór wielu dziedzin
                sztuki przenika się z zapachem świeżo parzonej kawy najwyższej
                jakości.
              </p>
              <p>
                Piękne i nowoczesne wnętrza pozwalają na spędzanie czasu w
                cieszącej ciało i duszę atmosferze, dopełnianej przez otwartych
                i zawsze gotowych do pomocy pracowników.
              </p>
              <p>
                Tym, co wyróżnia nową przestrzeń Centrum Kultury w Knurowie,
                jest przede wszystkim wielofunkcjonalność. Znajdziecie tutaj
                zarówno przestronną salę taneczną, pozwalającą uwolnić swoje
                twórcze pragnienia, jak i kawiarniany zakątek, gdzie w wygodnym,
                stylowym fotelu słuchać będzie można sączącej się muzyki.
              </p>
              <p>
                Sala plastyczna stworzona została z myślą o kreatywnym
                rozwijaniu zainteresowań osób w każdym wieku, a serwowane w Art
                Cafe pyszności towarzyszyć będą tym twórczym działaniom,
                uszczęśliwiając nie tylko ducha, ale i ciało!
              </p>
              <p>
              ...
              <p>
                Jesteśmy dumni, że będziecie tu razem z nami. Tylko przenikająca
                się wspólna, dobra energia pozwala na tworzenie miejsc z pasją.
                Zapewniamy Was, że dołożymy wszelkich starań, abyście zawsze
                czuli się w naszej przestrzeni gośćmi, na których gospodarz
                czeka z niecierpliwością i utęsknieniem!
              </p>
              <br />
              <p>
                <b>Zapraszamy!</b>
