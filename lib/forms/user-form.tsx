...
export const userValidationSchemaIncludingPassword: z.ZodType<TRegisterFormValues> =
  z
    .object({
...
export type TRegisterFormInputs = z.TypeOf<
  typeof userValidationSchemaIncludingPassword
>;
